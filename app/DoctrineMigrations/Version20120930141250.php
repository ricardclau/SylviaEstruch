 ...
 */
class Version20120930141250 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE Pintura ADD CONSTRAINT FK_269B76BD12469DE2 FOREIGN KEY (category_id) REFERENCES categorias_pintura (id)");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE Pintura DROP FOREIGN KEY FK_269B76BD12469DE2");
